...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var reference = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1) {
    return (function() {
      return $uD(delta$1.apply__O())
    })
  })(delta));
  var deltaVal = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  ...
  var bVal = new $c_Lcalculator_Signal().init___F0(expr$1);
  $m_Lcalculator_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2) {
    return (function() {
      return (2 * $uD(a$2.apply__O()))
    })
  })(a));
  var denomVal = new $c_Lcalculator_Signal().init___F0(expr$2);
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(deltaVal$1) {
    return (function() {
      var x = $uD(deltaVal$1.apply__O());
      return $uD($g["Math"]["sqrt"](x))
    })
  })(deltaVal));
  var sqrtDelta = new $c_Lcalculator_Signal().init___F0(expr$3);
  $m_Lcalculator_Signal$();
  var expr$4 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(deltaVal$1$1, bVal$1, denomVal$1, sqrtDelta$1) {
    return (function() {
      if (($uD(deltaVal$1$1.apply__O()) >= 0)) {
        var array = [(($uD(bVal$1.apply__O()) + $uD(sqrtDelta$1.apply__O())) / $uD(denomVal$1.apply__O())), (($uD(bVal$1.apply__O()) - $uD(sqrtDelta$1.apply__O())) / $uD(denomVal$1.apply__O()))];
      ...
      } else if (($uD(deltaVal$1$1.apply__O()) === 0)) {
        var array$1 = [($uD(bVal$1.apply__O()) / $uD(denomVal$1.apply__O()))];
  ...
  })(deltaVal, bVal, denomVal, sqrtDelta));
  return new $c_Lcalculator_Signal().init___F0(expr$4)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var expr = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
